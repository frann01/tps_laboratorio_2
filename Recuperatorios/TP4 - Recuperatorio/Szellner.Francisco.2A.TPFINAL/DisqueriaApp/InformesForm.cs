...
namespace DisqueriaApp
{
    public partial class InformesForm : Form
    {
        ...
        public InformesForm()
        {
            ...
            this.VentasDelForm = this.ObtenerLista("SELECT * FROM dbo.Ventas");
            this.label8.Text = this.VentasDelForm.Count + " Discos";
        ...
        private void ObtenerPorcentajeVinilo()
        {
            List<Venta> vVinilo = this.VentasDelForm.FindAll(EsVinilo);

            int porcentajeV = (vVinilo.Count * 100)/this.VentasDelForm.Count;

            this.label12.Text = porcentajeV + "% con " +vVinilo.Count+ " Discos";
        }

        private void RangoEtario()
        {
            List<Venta> MAYOR30 = this.VentasDelForm.FindAll(esMayorde30);
            List<Venta> MENOR30 = this.VentasDelForm.FindAll(esMenorDe30);
            ...
            {
                this.label9.Text = "menores de 30 años";
            }
            else
            {
                this.label9.Text = "mayores de 30 años";
            }
        }

        private void obtenerGeneroMenosComprado()
        {
            string mostrarMenor = "";
            ...
            {
                this.label7.Text = "- Se vendio la misma cantidad de todos los generos";
                this.label10.Text = "";
            }
            else
            {
                ...
                this.label10.Text = mostrarMenor + "con " + minimo + " discos";
            }

        }

        private void promedioPrecio() 
        {
            float total = 0;
            foreach(Venta item in this.VentasDelForm) 
            {
                total += item.DiscoVendido.Precio;
            }

            float promedio = total / this.VentasDelForm.Count;
